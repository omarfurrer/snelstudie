<form id='form__cotent_block' action="{{ isset($contentBlock)? '/admin/content_blocks/'.$contentBlock->id : '/admin/content_blocks' }}" 
    ...
    <div class="form-group">
        ...
        <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" 
               id="name" name="name" type="text" value="{{ old('name',isset($contentBlock)? $contentBlock->name : '') }}" required>
    ...
    <div class="form-group">
        ...
        <input class="form-control{{ $errors->has('code') ? ' is-invalid' : '' }}" 
               id="code" name="code" type="text" value="{{ old('code',isset($contentBlock)? $contentBlock->code : '') }}" required>
